" File: dark_r.vim
" Version: 1.1
" Author: rivkafisher100@gmail.com
...
exe "hi Search"      .s:v.'fg=bg'    .s:v.'bg='.s:yel .s:v.'=NONE'
exe "hi MoreMsg"     .s:v.'fg=fg'                    .s:v.'=NONE'
exe "hi LineNr"      .s:v.'fg='.s:gr1.s:v.'bg='.s:gr2
".s:v.'=italic'
exe "hi CursorLineNr".s:v.'fg='.s:pin    .s:v.'bg='.s:gr2
exe "hi Question"    .s:v.'fg='.s:pin                    .s:v.'=NONE'
exe "hi StatusLine"  .s:v.'fg='.s:green    .s:v.'bg='.s:gr2.s:v.'=NONE'
...
exe "hi Visual"      .s:v.'fg=bg'    .s:v.'bg=fg' .s:v.'=bold'
exe "hi WarningMsg"  .s:v.'fg='.s:cya                    .s:v.'=NONE'
